...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="MacOS" key="wt3SPsYtFW"><RenderMd content={`\`\`\`Bash
export ARK_API_KEY="your_api_key_here"
\`\`\`

`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Linux" key="QYwJoW6jn4"><RenderMd content={`\`\`\`Bash
export ARK_API_KEY="your_api_key_here"
\`\`\`

`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Windows_CMD" key="C88yBa99Wj"><RenderMd content={`\`\`\`Bash
setx ARK_API_KEY "your_api_key_here"
\`\`\`

`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Windows_PowerShell" key="Foc22jOcm5"><RenderMd content={`\`\`\`PowerShell
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="vSIxvEIyGe"><RenderMd content={`> 运行环境中需安装 [Python](https://www.python.org/downloads/) 版本 3.7 或以上。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="LPWmU4J7ym"><RenderMd content={`> 环境中安装 [Go](https://golang.google.cn/doc/install) 版本 1.18 或以上。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="YpkHHPxsg1"><RenderMd content={`> 环境中安装 [Java](https://www.java.com/en/download/help/index_installing.html) 版本 1.8 或以上。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="W479J8qwYE"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Curl" key="fDEGBoFkc5"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="O1Aju7uMEy"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="bUBh3H6xuf"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="f6BReGbddu"><RenderMd content={`\`\`\`Python
import os
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="qRTMQG1xIu"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Curl" key="KF9y0JDCv7"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/responses \\
-H "Authorization: Bearer $ARK_API_KEY" \\
-H 'Content-Type: application/json' \\
-d '{
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="Qntg5NH6XG"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="zVZgdljxsa"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="rzpviFjkZF"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="OlUI3wooXR"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Curl" key="Xa2GwdV7nX"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="XnsjYAnkQa"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="FqrdCVK4zH"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="JJaFOv33zU"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="hPQiyEMIrY"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="hyZGCeF8Zq"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="OK4ziHYC40"><RenderMd content={`\`\`\`Go
package main
...
* [视频生成（Ark for TT）](/docs/82379/1366799)：学习如何使用模型的视频生成能力，包括文本生成视频、首尾帧生视频、首帧生成视频等。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="YOSbWMq43e"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Curl" key="D5IOu4bUU5"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/responses \\
-H "Authorization: Bearer $ARK_API_KEY" \\
-H 'Content-Type: application/json' \\
-d '{
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="FP6VMvZOFz"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="pNeN807xpc"><RenderMd content={`\`\`\`Go
package main
import (
  "context"
  "fmt"
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="VuyzGqApO2"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
